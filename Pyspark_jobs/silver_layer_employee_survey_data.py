...
def silver_layer_employee_survey_data():

    name_map = {
        "EmployeeID" : "employee_id",
        "EnvironmentSatisfaction" : "lvl_environment_satisfaction", 
        "JobSatisfaction" : "lvl_job_satisfaction", 
        "WorkLifeBalance": "lvl_work_life_balance"
    }
    ...
    df = spark.read.parquet(f'{args.bronze_path}/employee_survey_data/')
    ...
    integer_cols = ["EmployeeID", "EnvironmentSatisfaction", 
    ...
    df = (df
        ...
        # Adding Metadata 
        .transform(lambda df: u.add_metadata(df, args.bronze_path, "employee_survey_data"))
...
if __name__ == '__main__':
    silver_layer_employee_survey_data()
